...
(() => {
  ...
  const CSS = `
    ...
    html body.dark {
      ...
      --veloura-v88-search-glass: color-mix(
        in srgb,
        var(--veloura-v88-tint) 40%,
        transparent
      );
      --veloura-v88-search-filter: blur(18px) saturate(200%);
    ...
    html body.dark.veloura-glass-effect #veloura-header-tabs-stack .veloura-detached-search.veloura-search-surface {
      ...
      background: var(--veloura-v88-search-glass) !important;
      background-color: var(--veloura-v88-search-glass) !important;
      background-image: none !important;
      ...
      -webkit-backdrop-filter: var(--veloura-v88-search-filter) !important;
      backdrop-filter: var(--veloura-v88-search-filter) !important;
      filter: none !important;
