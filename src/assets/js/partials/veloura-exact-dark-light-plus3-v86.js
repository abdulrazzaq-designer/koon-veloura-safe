...
(() => {
  ...
  const SHADOW_CSS = `
    ...
    :host([${THEME_ATTR}='dark']) {
      ...
      --v86-surface: color-mix(in srgb, var(--v86-dark-tint) 88%, transparent);
      --v86-solid: var(--v86-dark-source);
      --v86-edge-top: rgba(255, 255, 255, .040);
      --v86-edge-bottom: rgba(255, 255, 255, .072);
      --v86-shadow: rgba(0, 0, 0, .24);
      --v86-overlay: rgba(0, 0, 0, .30);
      --v86-filter: blur(22px) saturate(128%);
