...
(() => {
  ...
  const SHADOW_CSS = `
    ...
    :host([${THEME_ATTR}='dark']) {
      ...
      --v86-surface: color-mix(in srgb, var(--v86-dark-source) 78%, transparent);
      --v86-solid: var(--v86-dark-source);
      --v86-edge-top: rgba(255, 255, 255, .045);
      --v86-edge-bottom: rgba(255, 255, 255, .075);
      --v86-shadow: rgba(0, 0, 0, .22);
      --v86-overlay: rgba(0, 0, 0, .30);
      --v86-filter: blur(22px) saturate(130%);
      --v86-control: color-mix(in srgb, var(--v86-dark-source) 74%, transparent);
